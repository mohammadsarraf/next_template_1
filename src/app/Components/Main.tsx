    ...
    return (
        <div className=" text-white flex-grow px-10 py-3">
            ...
            <div className="flex justify-end items-center mt-8">
                <a title="Another Page" href="" className="flex items-center space-x-2 text-grey-500 no-underline transition-transform hover:translate-x-2 transform hover:scale-105 duration-300 ease-in-out">
